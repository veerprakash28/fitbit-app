...
const AddClient = ({ isOpen, setIsOpen, setData }) => {
  ...
  // Function to Add New Client and Schedule Appointment
  const handleAddClient = () => {
    if (validateForm()) {
      ...
      // Fetch existing clients from localStorage
      ...
      // Store the updated clients in localStorage
